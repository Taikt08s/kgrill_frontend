...
const AcceptOrder = ({ orderId, refreshOrders }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.get(
                `https://kgrill-backend-xfzz.onrender.com/api/v1/delivery-order/accept-order?orderId=${orderId}`,
                {
                    headers: {
            ...
            setSnackbarMessage('Đơn hàng đã được nhận thành công');
            ...
            setSnackbarMessage('Đã xảy ra lỗi khi nhận đơn hàng');
    ...
    return (
        <>
            <Button className="success" color="success" onClick={handleOpen}><FiCheck /></Button>
